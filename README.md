...
2. Execute the `win_pack_assets` script found in the `tools` directory to package resources.
3. Navigate to `project_files\windows` and open the project solution in Visual Studio.
4. Build and run.
